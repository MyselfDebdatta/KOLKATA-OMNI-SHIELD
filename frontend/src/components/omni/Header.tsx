        ...
        <nav className="hidden items-center gap-1 md:flex">
          ...
          {!isOverview && (
            <>
              ...
              <Link to="/emergency" className="rounded-full px-4 py-1.5 text-sm text-muted-foreground hover:text-foreground transition hover:bg-white/5" activeProps={{ className: "rounded-full px-4 py-1.5 text-sm font-medium text-foreground bg-white/10" }}>{t("emergency", lang)}</Link>
